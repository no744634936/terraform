...
resource "aws_autoscaling_group" "my_asg" {
  ...
  target_group_arns = module.nlb.target_group_arns //与load balancer 联系起来，23号文件里有这个变量， target_group_arns = ["arn:aws:elasticloadbalancing:ap-northeast-1:542542141872:targetgroup/app1-20221125212223023800000004/34bea09efbfeb43f",]
